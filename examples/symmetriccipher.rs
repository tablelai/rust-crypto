...
fn main() {
    ...
    let key = [
        55, 90, 114, 88, 116, 48, 52, 49, 55, 73, 119, 76, 81, 82, 79, 56, 67, 72, 86, 48, 105, 79,
        113, 122, 97, 110, 79, 119, 67, 112, 106, 79,
    ];
    let iv = [
        65, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 49, 50, 51, 51,
    ];
    ...
    let d = [
        167, 113, 181, 244, 135, 67, 154, 161, 193, 26, 85, 16, 239, 175, 86, 1,
    ];
    let d = decrypt(&d, &key, &iv).ok().unwrap();
    println!("{:?}", &d[..]);
